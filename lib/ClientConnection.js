...
function ClientConnection() {
    ...
    // eventually clean up
    // @todo this better, of course
    setTimeout(function () {
        if (ClientConnection.activeConnectionMap[this._id] === this) {
            delete ClientConnection.activeConnectionMap[this._id];
            console.log('client cleaned up!', this._id);
        }
    }.bind(this), 3600 * 1000);
